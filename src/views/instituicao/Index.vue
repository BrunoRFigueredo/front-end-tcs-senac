          ...
          <div class="col-xs-12 col-sm-4" v-for="instituicao in instituicoes.conteudo" :key="instituicao.id">
            <div class="card">
              <router-link :to="`/instituicao/${instituicao.id}`">
                <a class="img-card">
                  <img
                      :src="'data:image.'+ instituicao.usuario.imagem.fileType.split('/')[1] +';base64,' + instituicao.usuario.imagem.file"
                      alt="Logo">
                </a>
              </router-link>
              <div class="card-content">
                ...
                <div>
                  ...
                  <span @click="this.enviaMensagem(instituicao.telefone)"> - <img src="../../assets/whatsapp.png"
                                                                                  width="20" alt=""></span>
                </div>
                <div>
                <span>
